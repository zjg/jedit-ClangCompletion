...
public class ManualIncludeOptionsPane extends AbstractOptionPane
{
   ...
   static private final String INCLUDE_DIRS = "includeDirs";

   JList includeDirsList;
   DefaultListModel includeDirsModel;

   public ManualIncludeOptionsPane()
   {
      super("clangcompletion_manualInclude");
   }
   ...
   private void addIncludeDir()
   {
      String dir = (String)JOptionPane.showInputDialog(
         this, jEdit.getProperty(MESSAGE + "enterIncludeDir"),
         jEdit.getProperty(ClangCompletionPlugin.NAME + "title"),
